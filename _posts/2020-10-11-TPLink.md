...
```
The buffer containing the command is freed, then snprintf'd from the command line passed as a parameter, and straight from there (no sanitisation or any other check) passed to *system()*.  
