...
4. Write the string "password:<hash>" with the hash obtained previously
5. Close the dropbearpwd file

Note that the hashing function is an old friend as well, the function **cen_md5MakeDigest**
