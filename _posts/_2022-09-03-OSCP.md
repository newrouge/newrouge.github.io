...
9. Want to bruteforce phpmyadmin over a socks proxy?
...
I used a custom charset because I noticed that the string generated by msf-pattern_create did not always crash the target, and for a curious reason, this would work most of the time.
...
```
Run with python 2, for some reason, I've had trouble with non printable characters and python 3.
