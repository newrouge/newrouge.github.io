...
```
Setup iptables just like for meterpreter/reverse_tcp_allports, but make sure port 80 is queryable, and start the netcat black hole:
...
* gcc and required libs are on the machine: compile your exploit directly there
...
```
Once the file system is mounted, you can read/write /etc/passwd and /etc/shadow. You can also add your public ssh key in /root/.ssh/authorized_keys.
