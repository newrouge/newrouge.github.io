...
Most tips are from [hack tricks]([url](https://book.hacktricks.xyz/windows-hardening/active-directory-methodology/printers-spooler-service-abuse)).
...
[LaZagne]([url](https://github.com/AlessandroZ/LaZagne)) 
