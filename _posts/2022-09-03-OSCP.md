...
Buffer overflows for the OSPC are always on 32 bits executables, so EIP will always contain 4 bytes. In this case, if your EIP register contains **42424242** at the time of the crash, then you have a successful EIP rewrite.
