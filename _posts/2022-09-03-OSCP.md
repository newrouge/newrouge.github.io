...
- [Part 1: Essential Tools](#part-1--essential-tools)
  * [Kali, but really an distro with the right tools is fine too](#kali--but-really-an-distro-with-the-right-tools-is-fine-too)
  * [CopyQ (https://hluk.github.io/CopyQ/)](#copyq--https---hlukgithubio-copyq--)
  * [[Foxy Proxy]([url](https://addons.mozilla.org/en-US/firefox/addon/foxyproxy-standard/)) or [Container Proxy]([url](https://addons.mozilla.org/en-US/firefox/addon/container-proxy/))](#-foxy-proxy---url--https---addonsmozillaorg-en-us-firefox-addon-foxyproxy-standard----or--container-proxy---url--https---addonsmozillaorg-en-us-firefox-addon-container-proxy---)
...
## Kali, but really an distro with the right tools is fine too
