...
**WARNING: Modifying the PV1 firmware will leave the device in an unstable state. This PoC is not intended to be reproduced, and should <ins>NEVER</ins> be used against a real bike. It can damage the ECU, and will likely brick the Powervision.**
