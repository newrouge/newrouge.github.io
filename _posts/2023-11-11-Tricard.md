...
<span style="color:blue">source IP</span>_<span style="color:blue">sample name</span>_<span style="color:blue">epoch compilation</span><span style="color:blue">json reception timestamp</span>.json
...
* Key: sample name_epoch compile time
* Values:
