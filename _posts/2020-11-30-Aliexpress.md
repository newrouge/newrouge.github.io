...
```
Supposedly it is randomly generated and uniquely identifies a captcha response submission. It comes from the getcaptcha reponse so it does not really prevent from automatic form submission.  
